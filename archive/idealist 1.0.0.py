...
def newevent():
    global ideacat, ideas, input, exploremode, c1, eventl, hstop, hstart, mode, dlist
    appuifw2.app.screen='normal'
    a=[]
    for i in ideacat:
        a.extend([i[0]])
...
def difflist(input):
    ...
    if input==[[]]:
        ...
        if time.time()-hstart*3600<viewday:
            ...
            return 0
        #If time now above the time schedule
    ...
    varr=[hstart,0]
    #Usual, unempty day
    #A loop over all events in the prepare()d day
    for i in input:
